...
public record Competition(String name, String discipline, Set<Competitor> competitors) {
    ...
    public Competition {
        if (name == null || name.isBlank()) {
            throw new IllegalArgumentException("Competition's name cannot be null or blank");
        }

        if (discipline == null || discipline.isBlank()) {
            throw new IllegalArgumentException("Discipline cannot be blank");
        }

        if (competitors == null || competitors.isEmpty()) {
            throw new IllegalArgumentException("Competitors cannot be empty");
        }
    }
